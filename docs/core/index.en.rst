...
All controllers are held in the :class:`~licorn.core.LicornMasterController`, abbreviated **LMC** (in the :ref:`daemon <daemon.en>`, ``LMC`` is a global instance).

The Licorn® master controller
=============================

The ``LMC`` is one of the most important and central part of the ``core``. It has :ref:`its own dedicated page <core.lmc.en>`.
