...
# ============================================================= Local variables
MS_BASE_DIR           = os.path.join(LMC.configuration.home_base_path, 'windows')
...
if potential_overwriter:
	...
	for thing_to_overwrite, remove_first in (
		...
		#chown -R ${USER} Programmes "Menu Démarrer" Bureau
		print '>> TODO: ackcheck the logon scripts.'
		#workers.aclcheck_enqueue()
...
assert ltrace(TRACE_SAMBA3, '  Netlogon script {0} build finished', script_filename)
