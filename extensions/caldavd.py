...
from calendarserver.tools.principals   import action_addProxy, action_removeProxy,  addProxy, \
			action_readProperty, getProxies, principalForPrincipalID, action_listProxies
